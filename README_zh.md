...
| 平台 | 开发调试 | 安装包构建 | 获取方式 |
|------|:--------:|:----------:|----------|
| **macOS** (x86_64 / aarch64) | ✅ | ✅ `.dmg` | 本地构建 / [GitHub Actions Releases](https://github.com/zhaoyang8518/cpk_qc/releases) |
| **Windows** (x86_64) | — | ✅ `.msi` | [GitHub Actions Releases](https://github.com/zhaoyang8518/cpk_qc/releases) |
| **Linux** | ✅ | 待支持 | 本地 `pnpm tauri dev` |

> **安装包自动构建**：每次向 `main` 分支推送代码，GitHub Actions 自动构建 Windows 和 macOS 安装包，可在 [Releases](https://github.com/zhaoyang8518/cpk_qc/releases) 页面下载最新 Release 或在 [Actions](https://github.com/zhaoyang8518/cpk_qc/actions) 下载 Artifact。
...
下载路径：[GitHub Releases](https://github.com/zhaoyang8518/cpk_qc/releases)
